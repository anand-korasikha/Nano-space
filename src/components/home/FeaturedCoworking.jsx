    ...
    return (
        <section className="py-16 bg-white overflow-hidden">
            <div className="max-w-[90%] mx-auto px-4 md:px-8 lg:px-16">
                    ...
                    <div className="flex gap-16 items-center animate-marquee whitespace-nowrap">
                        {brands.map((brand, index) => (
                            <div key={index} className="w-32 h-12 md:w-40 md:h-16 flex-shrink-0 flex items-center justify-center grayscale hover:grayscale-0 transition-all opacity-70 hover:opacity-100">
                                ...
                                <span className="text-xl font-bold text-gray-400 capitalize hidden">{brand.name}</span>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                {/* Banner */}
                <div className="bg-[#FFFDF2] rounded-3xl overflow-hidden shadow-sm border border-yellow-100 flex flex-col md:flex-row relative">
                    ...
                    <div className="w-full md:w-3/5 p-8 md:p-12 relative z-10">
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 mt-4 text-gray-600 font-medium">
                    ...
                    <div className="w-full md:w-2/5 relative min-h-[300px] md:min-h-auto">
                        <div className="absolute inset-0 bg-gradient-to-l from-transparent to-[#FFFDF2] z-10 w-24 -ml-1"></div>
                        <img
