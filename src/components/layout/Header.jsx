                ...
                <nav className="header-center">
                    <ul className="nav-list">
                        ...
                        <li
                            ...
                            onMouseEnter={() => setIsCoworkingDropdownOpen(true)}
                            onMouseLeave={() => setIsCoworkingDropdownOpen(false)}
                        >
                            <NavLink
                                to="/coworking"
                        ...
                        <li
                            className="nav-item-dropdown"
                            onMouseEnter={() => setIsColivingDropdownOpen(true)}
                            onMouseLeave={() => setIsColivingDropdownOpen(false)}
                        >
                            <NavLink
                                to="/coliving"
                                className={({ isActive }) => isActive ? 'nav-link active' : 'nav-link'}
                        ...
                        <li
                            className="nav-item-dropdown"
                            onMouseEnter={() => setIsVirtualOfficeDropdownOpen(true)}
                            onMouseLeave={() => setIsVirtualOfficeDropdownOpen(false)}
                        >
                            <NavLink
                                to="/virtual-office"
                                className={({ isActive }) => isActive ? 'nav-link active' : 'nav-link'}
                        ...
                        <li><NavLink to="/business-plans" className={({ isActive }) => isActive ? 'nav-link active' : 'nav-link'}>Business Plans</NavLink></li>
                    </ul>
                </nav>
