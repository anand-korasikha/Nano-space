...
const Buy = () => {
    ...
    useEffect(() => {
        const fetchBackendProperties = async () => {
            setLoading(true);
            try {
                const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:5000/api'}/properties/?status=approved&buy=true`);
                if (response.ok) {
        ...
        <div className="new-horizontal-card">
            ...
            <div className="card-media">
                ...
                <div className="social-proof">
                    ...
                    <span>{Math.floor(Math.random() * 10) + 2} people contacted in last 24h</span>
                </div>
            </div>
                ...
                <div className="card-main">
                    ...
                    <div className="stats-row">
                        <div className="stat-box">
                            <div className="stat-primary">{property.price}</div>
                            <div className="stat-secondary">₹{Math.floor(Math.random() * 3000) + 4000}/sqft</div>
                        </div>
                    ...
                    <p className="property-snippet">
                        {property.description || `This ${property.type} offers modern amenities and excellent connectivity in ${property.city}. Perfect for families looking for a premium lifestyle.`}
                    </p>
                </div>

                <div className="card-footer">
                    <div className="footer-left">
                        <div className="timestamp-row">Builder • {Math.floor(Math.random() * 5) + 1}mo ago</div>
                        <div className="vendor-name">NANOSPACE DEVELOPERS</div>
                    </div>
